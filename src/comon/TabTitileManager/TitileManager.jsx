...
const titles = {
  ...
  '/login': 'شهر کراد | ورود',
  '/article1': 'لوتوس کراد | قوانین تأمین مالی جمعی در ایران ',
  '/article2': 'لوتوس کراد | تأمین مالی جمعی از گذشته تا امروز ',
  '/article3': 'لوتوس کراد | انواع روش‌های تأمین مالی جمعی ',
  '/article4': 'لوتوس کراد | کرادفاندینگ چیست؟ ',
