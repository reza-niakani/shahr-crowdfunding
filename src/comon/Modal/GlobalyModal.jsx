          ...
          <div className=" flex flex-col justify-start items-center gap-y-8 bg-white p-5  lg:w-[50vw] w-[90vw] rounded-lg ">
            ...
            <div
              ...
              <p className="mb-4">
                ...
                ریسک‌هایی برای تامین‌کننده است و زاگرس کراد به‌عنوان عامل مجاز، برخی از خطرات این
          ...
          <div className=" flex flex-col justify-start items-center gap-y-8 bg-white p-5  lg:w-[50vw] w-[90vw] rounded-lg ">
            ...
            <div
              ...
              <ol className="list-decimal pr-5 space-y-4">
                <li>
                  کاربران محترم زاگرس کراد؛ سکو برای ارائه بهتر و رعایت الزامات کارگروه تامین مالی
                  جمعی شرکت فرابورس ایران و برحسب خدمت از اطلاعات شخصی شما همچون نام و نام خانوادگی،
                  شماره تماس، کد ملی، ایمیل و ... را درخواست نماید.
                </li>
                <li>
                  زاگرس کراد جهت بروز رسانی اطلاعات سجام کاربران خود، شرایطی را محیا نموده تا با
                  بروز رسانی اطلاعات هویتی ثبت شده در سجام، سود سرمایه‌گذاری‌های خود به حساب تعریف
                  شده در سجام انتقال دهند.
                </li>
                <li>
                  زاگرس کراد برای بهبود تجربه کاربری، از «کوکی‌ها» استفاده کند. مرورگرهای اینترنت،
                ...
                <li>
                  زاگرس کراد برای جلوگیری از دسترسی بدون مجوز و غیرقانونی به اطلاعات وب‌سایت و
                  کاربران آن، اقدام‌های امنیتی را تا جایی که در توانش است، برقرار کرده‌ است و همواره
                  امنیت کاربران و اطلاعات آن‌ها از اولویت‌هایش است. با این وجود زاگرس کراد هیچ
                  تضمینی را در خصوص نفوذ غیرقانونی به سامانه‌هایش ارائه نمی‌دهد.
                </li>
                <li>
                  زاگرس کراد اطلاعات شخصی کاربران و بازدیدکنندگانش را به دیگران نفروخته و اجاره
                  نمی‌دهد. زاگرس کراد ممکن است از نرم‌افزارها و سرویس‌دهنده‌هایی برای ارائه خدمات به
                  کاربرانش استفاده کند. در این شرایط اطلاعات کاربران تحت نظارت وب‌سایت زاگرس کراد
                  توسط این سرویس‌ها و نرم‌افزارها استفاده خواهد شد.
                </li>
                <li>
                  زاگرس کراد اطلاعات کاربران را در پاسخ به درخواست احضاریه، درخواست دادگاه یا هر
                  فرایند قانونی مشابه دیگر، و یا دفاع از حقوق قانونی خود در برابر ادعاهای وارده ممکن
                  است به اشتراک بگذارد.
                </li>
              </ol>
              <p className="mt-6">
                تیم اجرایی زاگرس کراد با تمام همت خود در راستای شعار سازمانی خود &rdquo;زاگرس، نماد
                سرمایه‌گذاری&rdquo; سعی در محیا نمودن محیطی شفاف جهت سرمایه‌گذاری کاربران خود بکار
                خواهد گرفت. سکوی زاگرس کراد هر زمان که دچار تغییر در سیاست محرمانگی خود گردید آن را
                در همین صفحه اعلام می‌دارد.
              </p>
