    ...
    <div className="w-full flex flex-col justify-start items-center gap-y-3">
      ...
      <div
        ...
        dangerouslySetInnerHTML={{
          __html: `
    «تامین مالی جمعی» به‌عنوان روشی برای سرمایه‌گذاری، مشابه سایر روش‌ها، متضمن ریسک‌هایی برای تامین‌کننده است و تامین سرمایه بانک ملت به‌عنوان عامل مجاز، برخی از خطرات این سرمایه‌گذاری را در اجرای مواد ۲۹ و ۳۰ «دستورالعمل تامین مالی جمعی»، به شرح زیر به اطلاع تامین‌کنندگان محترم می‌رساند:<br><br>
    ...
    ۳- عامل در محدوده قوانین، مقررات و توافقات فی‌مابین، مسئول بررسی صحت اسناد و مدارک و ارائه خدمات مربوط به تامین مالی جمعی است. به همین دلیل، در راستای اجرای ماده ۳۲ «دستورالعمل تامین مالی جمعی» عامل توصیه به سرمایه‌گذاری در هیچ طرح خاصی نخواهد کرد.`
      ...
      <div className="w-full flex lg:flex-row flex-col lg:items-center items-start  h-auto gap-3 justify-between pt-3 ">
        <button
          ...
          className={`min-w-[115px] lg:h-[48px] h-[38px] bg-accent-1000 ${
            !role && ' opacity-60'
        ...
        <div
          ...
          />
          <span className="text-nowrap text-gray-700 text-xs">پذیرش بیانه ریسک سرمایه‌گذاری </span>
        </div>
      </div>
    </div>
  );
