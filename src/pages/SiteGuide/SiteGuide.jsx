      ...
      <div className="  bg-[url('asset/Pictures/BackGround/landingBg.svg')]  bg-cover w-screen  bg-no-repeat  bg-center lg:h-[600px] flex flex-col  justify-center   items-center gap-y-16 lg:py-0 ">
        <div className=" lg:w-[50%] w-[95%] flex flex-col items-center justify-center h-auto gap-y-10  pt-28 ">
          ...
          <p
            ...
            فرآیندهای زاگرس کراد به‌گونه‌ای طراحی شده‌اند که برای هر دو گروه سرمایه‌گذار و
            سرمایه‌پذیر، ساده، شفاف و قابل پیگیری باشند. چه بخواهید در طرحی اقتصادی سرمایه‌گذاری
            کنید و چه به‌دنبال جذب سرمایه برای توسعه کسب‌وکار خود باشید، مسیر مشخص و روشنی پیش روی
            شما قرار دارد. در ادامه، با مراحل کامل هر مسیر را به‌صورت گام‌به‌گام آشنا می‌شوید.
          </p>
        </div>
      </div>
      {/*  data as guid */}
